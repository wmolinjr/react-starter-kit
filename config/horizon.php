...
return [
    ...
    */
    ...
    'domain' => env('HORIZON_DOMAIN', env('APP_DOMAIN', 'app.test')),
    ...
    */
    ...
    'defaults' => [
        // High priority: emails, webhooks, notifications
        'supervisor-high' => [
            'connection' => 'redis',
            'queue' => ['high'],
            'balance' => 'auto',
        ...
        // Default: tenant operations, permission sync
        'supervisor-default' => [
            'connection' => 'redis',
            'queue' => ['default'],
            'balance' => 'auto',
        ...
        // Federation: user sync across tenants
        ...
        // Media: image conversions (CPU intensive)
        'supervisor-media' => [
            'connection' => 'redis',
            'queue' => ['media'],
            'balance' => 'auto',
