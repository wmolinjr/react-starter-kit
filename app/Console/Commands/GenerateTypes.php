...
TS;
    ...
    protected function generatePermissionTypes(): void
    {
        ...
        $output = $this->generatePermissionTypesContent($allPermissions, $categories, $actions);
    ...
    protected function generatePermissionTypesContent(array $permissions, array $categories, array $actions): string
    {
