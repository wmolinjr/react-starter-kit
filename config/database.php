...
return [
    ...
    */
    ...
    | - 'central': Central database for tenants, users, plans, subscriptions
    | - 'tenant': Template connection for per-tenant databases (dynamic)
    |
    */
    ...
    'connections' => [
        ...
        'sqlite' => [
            ...
            'journal_mode' => null,
            'synchronous' => null,
            // transaction_mode: null for tests (avoids PHP 8.4 nested transaction issue)
            // Use 'IMMEDIATE' for production SQLite with WAL mode
            'transaction_mode' => env('SQLITE_TRANSACTION_MODE', null),
        ],
        ...
        */
        ...
        // Legacy pgsql alias - points to central for backwards compatibility
        'pgsql' => [
            'driver' => 'pgsql',
            'url' => env('DB_URL'),
            'host' => env('DB_HOST', '127.0.0.1'),
