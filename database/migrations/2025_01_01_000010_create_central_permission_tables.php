...
/**
 * Central Migration: Permission Tables
 *
 * MULTI-DATABASE TENANCY:
 * - This migration runs on the CENTRAL database
 * - For central/admin roles (super_admin, central_admin)
 * - NO tenant_id - this is the central context only
 * - Each tenant has its own permission tables in their database
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        // - Central roles are in central database
        // - Tenant roles are in each tenant's database
