 ...
 * Generated at: 2025-11-20 20:01:53
 *
...
export type Permission =
  ...
  | 'tenant.api-tokens:view'  // View API tokens
  | 'tenant.api-tokens:create'  // Create API tokens
  | 'tenant.api-tokens:delete'  // Delete API tokens;
 ...
 */
export type Api-tokensPermission =
  | 'tenant.api-tokens:view'  // View API tokens
  | 'tenant.api-tokens:create'  // Create API tokens
  | 'tenant.api-tokens:delete'  // Delete API tokens;
