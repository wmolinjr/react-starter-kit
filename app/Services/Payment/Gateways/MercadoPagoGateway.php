...
class MercadoPagoGateway implements PaymentGatewayInterface, PaymentMethodGatewayInterface, SubscriptionGatewayInterface
{
    ...
    {
        return $customer->getProviderId('mercadopago') ?? $customer->id;
    }

    public function charge(Customer $customer, int $amount, array $options = []): ChargeResult
    {
        return ChargeResult::failed('MercadoPago gateway not yet implemented');
    }

    public function refund(Payment $payment, ?int $amount = null): RefundResult
    {
        return RefundResult::failed('MercadoPago gateway not yet implemented');
    }
    ...
    {
        return SetupIntentResult::failed('MercadoPago gateway not yet implemented');
    }

    public function attachPaymentMethod(Customer $customer, string $providerMethodId, array $options = []): PaymentMethodResult
    {
        return PaymentMethodResult::failed('MercadoPago gateway not yet implemented');
    }
    ...
    {
        return SubscriptionResult::failed('MercadoPago gateway not yet implemented');
    }
    ...
    {
        return SubscriptionResult::failed('MercadoPago does not support pausing subscriptions');
    }
    ...
    {
        return SubscriptionResult::failed('MercadoPago does not support resuming subscriptions');
    }
