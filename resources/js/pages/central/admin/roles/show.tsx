...
function ShowRole({ role }: Props) {
    ...
    // Get permissions and users with fallback to empty arrays
                    ...
                    <div className="grid gap-6 lg:grid-cols-2">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    {t('roles.page.permissions_granted')}
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
