...
class CreateTenantUserImpersonationTokensTable extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tenant_user_impersonation_tokens', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('tenant_id'); // Changed from string to unsignedBigInteger for auto-increment IDs
            $table->unsignedBigInteger('user_id');   // Changed from string to unsignedBigInteger for auto-increment IDs
