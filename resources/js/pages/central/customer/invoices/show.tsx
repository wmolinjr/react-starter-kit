...
function InvoiceShow({ invoice }: InvoiceShowProps) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: invoice.number, href: customer.invoices.show.url(invoice.id) },
    ];
...
InvoiceShow.layout = (page: ReactElement) => <CustomerLayout>{page}</CustomerLayout>;
