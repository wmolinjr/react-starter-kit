...
class StorePageBlockRequest extends FormRequest
{
    ...
    {
        return [
            'content.url' => ['required', 'string', 'max:500'],
    ...
    protected function ctaRules(): array
    {
        return [
            ...
            'content.button_text' => ['required', 'string', 'max:100'],
            'content.button_url' => ['required', 'string', 'max:500'],
            'config.alignment' => ['nullable', 'string', Rule::in(['left', 'center', 'right'])],
            'config.background_color' => ['nullable', 'string', 'max:50'],
    ...
    protected function testimonialsRules(): array
    {
        return [
            'content.title' => ['nullable', 'string', 'max:255'],
            'content.testimonials' => ['required', 'array', 'min:1'],
