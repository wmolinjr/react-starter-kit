...
return [
     ...
     *
     * IMPORTANT: We use SINGLE DATABASE with tenant_id isolation.
     * No separate databases are created per tenant.
     * template_tenant_connection = null means we use the same DB for all tenants.
     */
    'database' => [
        'central_connection' => env('DB_CONNECTION', 'pgsql'),

        /**
         * NULL = Single database strategy (tenant_id isolation)
         * All tenants share the same database, isolation via tenant_id column.
         */
    ...
    'features' => [
        ...
        Stancl\Tenancy\Features\UniversalRoutes::class, // Routes that work in both central and tenant contexts
