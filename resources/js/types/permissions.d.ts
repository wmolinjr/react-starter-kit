 ...
 * Generated at: 2025-12-09 00:28:03
 *
...
export type Permission =
  ...
  | 'federation:view'  // View federation settings
  | 'federation:manage'  // Manage federation settings
  | 'federation:invite'  // Invite tenants to federation
  | 'federation:leave'  // Leave federation group
  ...
  | 'federation:create'  // Create federation groups
  | 'federation:edit'  // Edit federation groups
  | 'federation:delete'  // Delete federation groups
  | 'federation:manageConflicts'  // Manage federation conflicts;
 ...
 */
export type FederationPermission =
  | 'federation:view'  // View federation settings
  | 'federation:manage'  // Manage federation settings
  | 'federation:invite'  // Invite tenants to federation
  | 'federation:leave'  // Leave federation group
