...
export function ProjectsExample() {
    ...
    return (
        <div>
            ...
            {(has('projects:edit') || has('projects:editOwn')) && (
            ...
            {/* Upload files */}
            {has('projects:upload') && <input type="file" onChange={handleUpload} />}
        </div>
    );
}
...
export function TeamExample() {
    ...
    return (
        <div>
            ...
            {hasAny('team:invite', 'team:manageRoles') && (
...
export function SettingsExample() {
    ...
    return (
        <div>
            ...
            <form>
                <input type="text" disabled={!has('settings:edit')} />

                {has('settings:edit') && <Button type="submit">Save Settings</Button>}
            </form>
...
export function ComplexPermissionExample() {
    ...
    return (
        <div>
            ...
            {hasAny('projects:edit', 'projects:editOwn') && (
                <Button onClick={handleEdit}>Edit Project</Button>
            )}

            {/* AND logic: Show if user has ALL of these permissions */}
            {hasAll('projects:view', 'projects:download') && (
